...
import static ru.rbt.ejb.conf.map.DecimalProperty.nullDecimalProperty;
import static ru.rbt.ejb.conf.map.NumberProperty.nullNumberProperty;
import static ru.rbt.ejb.conf.map.StringProperty.nullStringProperty;
