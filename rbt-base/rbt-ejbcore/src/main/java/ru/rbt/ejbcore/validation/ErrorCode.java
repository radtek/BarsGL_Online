...
//    GL_SEQ = XX
    ...
    , COB_IS_RUNNING(3016, "Залача COB за дату '%s' выполняется. Нельзя выполнить расчет")

    , OPERDAY_NOT_ONLINE(3020, "Обработка операций невозможна. Операционный день в статусе: '%s'")
    , OPERDAY_IN_SYNCHRO(3021, "Обработка операций невозможна. Выполняется синхронизация проводок,\n повторите попытку через несколько минут")
