...
public class TaskFormDlg extends DlgFrame{
    ...
    public Widget createContent() {
        ...
        grid.setWidget(0, 0, Components.createLabel("Тип запуска"));
        grid.setWidget(0, 1, createRunTypes());
        grid.setWidget(1, 0, Components.createLabel("Свойства"));
        grid.setWidget(1, 1, createProperty());
        grid.setWidget(2, 0, Components.createLabel("Тип задания"));
        grid.setWidget(2, 1, vJobType = Components.createTxtBox(64, "300px"));
        vJobType.setEnabled(false);
        grid.setWidget(3, 0, lShedule = Components.createLabel("Расписание"));
        grid.setWidget(3, 1, vShedule = Components.createTxtBox(512, "300px"));
