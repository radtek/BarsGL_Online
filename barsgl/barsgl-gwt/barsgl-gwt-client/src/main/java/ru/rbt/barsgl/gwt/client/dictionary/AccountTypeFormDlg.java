...
public abstract class AccountTypeFormDlg extends GridFormDlgBase {
    ...
    class AccountTypeGridForm extends GridForm {
        ...
        protected String prepareSql() {
            return "select * from  " +
                    "(select ACCTYPE, trim(CUSTYPE) CUSTYPE, TERM, ACC2, ACOD, SQ, DTB, DTE, ACCNAME, TERMNAME, CTYPENAME, CUSTNO, CUSTNAME, CTYPE, FL_CTRL" +
                    " from V_GL_ACCUST where not ACC2 like '706%') v";
        }
        ...
        public ArrayList<FilterItem> getInitialFilterCriteria(Object[] initialFilterParams) {
            ...
            list.add(new FilterItem(colDateEnd, FilterCriteria.GE, currentDate, true, true));
