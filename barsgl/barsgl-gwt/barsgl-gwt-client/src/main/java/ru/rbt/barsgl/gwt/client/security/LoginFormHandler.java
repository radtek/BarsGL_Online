...
public class LoginFormHandler {
    ...
    public void login() {
        ...
        BarsGLEntryPoint.authSrv.login(loginForm.getUserName(), loginForm.getPassword()
            ...
            public void onSuccess(LoginResult result) {
                if (LoginResult.LoginResultStatus.FAILED == result.getLoginResultStatus()) {
                    ...
                    BarsGLEntryPoint.prepare(result);
                }
    ...
    public static void logoff() {
        BarsGLEntryPoint.authSrv.logoff("", new AsyncCallback<LoginResult>() {
            @Override
            public void onFailure(Throwable caught) {
