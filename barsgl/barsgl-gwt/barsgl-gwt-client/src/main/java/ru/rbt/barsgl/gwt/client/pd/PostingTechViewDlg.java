...
public class PostingTechViewDlg extends EditableDialog<ManualTechOperationWrapper> {
    ...
    protected Grid createOneSide(String label, final Side side, boolean withValute) {
        ...
        grid.setWidget(5,1,
        mSum = createBtnDecBoxForSumma(20, SUM_WIDTH, new Image(ImageConstants.INSTANCE.coins()), "Конвертация по курсу ЦБ", new ICallMethod() {
                @Override
                public void method() {
                }
            }));
