...
public class AccountingType extends MDForm implements IAfterRefreshEvent {
    ...
    protected String prepareDetailSql() {
        return "select PARM.ACCTYPE, TRIM(PARM.CUSTYPE) CUSTYPE, PARM.TERM, PARM.ACC2, TRIM(PARM.PLCODE) PLCODE, PARM.ACOD, PARM.AC_SQ, PARM.DTB, PARM.DTE, NM.ACCNAME, case when NM.TECH_ACT='Y' then 'Y' else 'N' end as TECH_ACT "
