...
public interface ManualDictionaryServiceAsync {
    ...
    void saveBVSourceDeal(BVSourceDealWrapper wrapper, FormAction action, AsyncCallback<RpcRes_Base<BVSourceDealWrapper>> callback) throws Exception;
    void saveClosedReportPeriod(ClosedReportPeriodWrapper wrapper, FormAction action, AsyncCallback<RpcRes_Base<ClosedReportPeriodWrapper>> callback ) throws Exception;
