 ...
 */
public class DataGrid2<T> extends AbstractCellTable<T> implements RequiresResize {
    ...
    private static class ResourcesAdapter implements AbstractCellTable.Resources {
        ...
        private final DataGrid2.Resources resources;
        private final StyleAdapter style;

        public ResourcesAdapter(DataGrid2.Resources resources) {
    ...
    private static class StyleAdapter implements AbstractCellTable.Style {
        private final DataGrid2.Style style;

        public StyleAdapter(DataGrid2.Style style) {
            this.style = style;
        }
     ...
     */
    public DataGrid2(final int pageSize) {
     ...
     */
    public DataGrid2(int pageSize, ProvidesKey<T> keyProvider) {
     ...
     */
    public DataGrid2(int pageSize, Resources resources) {
     ...
     *          object should act as its own key
     */
    public DataGrid2(int pageSize, Resources resources, ProvidesKey<T> keyProvider) {
     ...
     *          object should act as its own key
     */
    public DataGrid2(ProvidesKey<T> keyProvider) {
