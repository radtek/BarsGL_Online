...
select pcid.pcid, dt.postingdate, dt.valuedate, dt.pid did, ct.pid cid, dt.bsaacid dcbaccount, ct.bsaacid ccbaccount, dt.hostsystem, dt.dealid, dt.pcid, abs(dt.amount) damount, abs(ct.amount) camount, dt.ccy dcur, ct.ccy ccur
