...
select (nextval for gl_seq_pst) id, '00'||cast (id_pst as varchar(64)) id_pst, value(?, 999999) id_pkg
       , 'FC6_PAY' src_pst, cast(p.evt_id as varchar(128)) evt_id, p.pmt_ref pmt_ref, p.vdate vdate, current timestamp ots
