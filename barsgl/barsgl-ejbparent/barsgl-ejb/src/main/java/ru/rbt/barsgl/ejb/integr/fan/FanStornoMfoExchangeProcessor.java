 ...
 */
public class FanStornoMfoExchangeProcessor extends FanOperationProcessor {

    @Inject
    FanMfoExchangeProcessor fanMfoExchangeProcessor;
    ...
    public void setSpecificParameters(GLOperation operation) throws Exception {
        fanMfoExchangeProcessor.setSpecificParameters(operation);
    }

    @Override
    public void addPosting(GLOperation operation, List<GLPosting> postList) throws Exception {
        fanMfoExchangeProcessor.addPosting(operation, postList);
    }
