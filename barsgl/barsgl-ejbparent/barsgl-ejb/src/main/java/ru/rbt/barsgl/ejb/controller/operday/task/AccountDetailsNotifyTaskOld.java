...
import ru.rbt.barsgl.ejb.controller.operday.task.srvacc.AccountDetailsNotifyProcessorOld;
 ...
 */
@Deprecated
public class AccountDetailsNotifyTaskOld implements ParamsAwareRunnable {

    private static final Logger log = Logger.getLogger(AccountDetailsNotifyTaskOld.class);
    private static final String SCHEDULED_TASK_NAME = "AccountDetailsNotify";
    private static final int defaultQueueBachSize = 5;

    @Inject
    private AccountDetailsNotifyProcessorOld messageProcessor;
