 ...
 * Created by ER22228
 */
public class KeyValueStorageSetterTest extends AbstractTimerJobTest {

    public static final Logger logger = Logger.getLogger(KeyValueStorageSetterTest.class.getName());
