 ...
 * @fsd 8.2
 */
public class UniAccountBalanceUnloadTest extends AbstractTimerJobTest {

    public static final Logger logger = Logger.getLogger(UniAccountBalanceUnloadTest.class.getName());
