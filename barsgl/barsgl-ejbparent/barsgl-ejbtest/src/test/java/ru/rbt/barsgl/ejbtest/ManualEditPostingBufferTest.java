...
public class ManualEditPostingBufferTest  extends AbstractTimerJobTest {
    ...
    private void checkCommonParams(GLOperation operation, List<AbstractPd> pdList, String dealId, String subDealId, String profit) {
        ManualEditPostingDirectTest.checkCommonParams(operation, pdList, dealId, subDealId, profit);
    }

    private void checkNarrative(List<AbstractPd> pdList, String narrEng, String narrRus) {
        ManualEditPostingDirectTest.checkNarrative(pdList, narrEng, narrRus);
    }

    private GLOperation createMfoExchOperation() throws SQLException {
        return ManualEditPostingDirectTest.createMfoExchOperation();
    }
}
