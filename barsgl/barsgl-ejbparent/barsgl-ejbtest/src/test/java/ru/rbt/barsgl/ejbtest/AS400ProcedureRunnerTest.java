 ...
 * Created by ER22228
 */
public class AS400ProcedureRunnerTest extends AbstractTimerJobTest {

    public static final Logger logger = Logger.getLogger(AS400ProcedureRunnerTest.class.getName());
