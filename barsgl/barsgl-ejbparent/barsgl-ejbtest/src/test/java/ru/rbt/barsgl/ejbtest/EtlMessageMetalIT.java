...
/**
 * Created by er22317 on 18.06.2018.
 * серебро
 */
    public class EtlMessageMetalIT extends AbstractTimerJobIT {

        public static final Logger log = Logger.getLogger(ru.rbt.barsgl.ejbtest.EtlMessageMetalIT.class.getName());
         ...
         */
        @Test
        public void testNoExch() throws ParseException, SQLException {
        ...
        private void del706(String bsaacc){
            ...
            baseEntityRepository.executeNativeUpdate("delete from gl_acc where bsaacid=?", bsaacc);
