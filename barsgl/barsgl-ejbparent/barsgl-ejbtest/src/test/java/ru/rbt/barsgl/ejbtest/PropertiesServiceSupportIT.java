 ...
 */
public class PropertiesServiceSupportIT extends AbstractRemoteIT {

  private static final Logger logger = Logger.getLogger(PropertiesServiceSupportIT.class.getName());
