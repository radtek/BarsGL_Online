...
public class AccountQueryProcessorIT extends AbstractRemoteIT {
    ...
    public void process() throws Exception {
        ...
        CommonQueueController.QueueProcessResult result = remoteAccess.invoke(AccountQueryProcessor.class, "process", testRequest, currencyMap, currencyNBDPMap, 0L, true);
