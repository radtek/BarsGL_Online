...
import ru.rbt.barsgl.ejb.controller.operday.task.srvacc.QueueProcessResult;
...
public class AccountQueryProcessorIT extends AbstractRemoteIT {
    ...
    public void process() throws Exception {
        ...
        QueueProcessResult result = remoteAccess.invoke(AccountQueryProcessor.class, "process", testRequest, currencyMap, currencyNBDPMap, 0L, true);
        String value = result.getOutMessage();
