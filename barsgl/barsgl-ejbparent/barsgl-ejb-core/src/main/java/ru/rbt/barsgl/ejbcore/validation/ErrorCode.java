...
public enum ErrorCode {
    ...
    , OPERDAY_NOT_ONLINE(3011, "Обработка операций невозможна. Операционный день в статусе: '%s'")
    ...
    , POSTING_STATUS_WRONG(4017, "Статус запроса на операцию не соответствует ожидаемому: '%s' (%s)")
    , PACKAGE_STATUS_WRONG(4018, "Статус пакета не соответствует ожидаемому: '%s' (%s)")
