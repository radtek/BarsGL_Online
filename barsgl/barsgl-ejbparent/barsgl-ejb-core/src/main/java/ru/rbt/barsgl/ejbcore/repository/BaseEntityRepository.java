...
public interface BaseEntityRepository<T extends BaseEntity, K extends Serializable> {
    ...
    /**
     * Возвращает {@link ru.rbt.barsgl.ejbcore.datarec.DataRecord} или <code>null</code> если ничего не найдено
     * @param sqlString выражение SQL
     * @param params перечисление параметров
     * @return результат в виде {@link ru.rbt.barsgl.ejbcore.datarec.DataRecord}
