...
//            }
    ...
    public List<DataRecord> getAccrlnRecords(String inCondition) {
        try {
            return selectMaxRows("SELECT * FROM DWH.ACCRLN A WHERE A.BSAACID IN (" + inCondition + ")" , Integer.MAX_VALUE, null);
        } catch (NoResultException e) {
    ...
    public List<DataRecord> getGlAccRecords(String inCondition) {
        try {
            return selectMaxRows("SELECT * FROM DWH.GL_ACC WHERE BSAACID IN (" + inCondition + ")\n", Integer.MAX_VALUE, null);
        } catch (NoResultException e) {
            return Collections.emptyList();
        } catch (Exception e) {
            log.error("",e);
