package ru.rbt.barsgl.audit.controller;

import org.apache.log4j.Logger;
import ru.rbt.barsgl.audit.repository.AuditRepository;
...
import static ru.rbt.barsgl.audit.entity.AuditRecord.LogLevel.Error;
import static ru.rbt.barsgl.audit.entity.AuditRecord.LogLevel.SysError;
...
//            int p = className.lastIndexOf(".");
    ...
    private String getShortMessage(Throwable throwable) {
        ...
        if (null != msg)
            pos = msg.indexOf("\tat ");
        return pos > 0 ? substr(msg, pos) : msg;
    }
